...
class DataModule {
    ...
    @Provides
    fun provideUpdateProfile(repository: IProfileRepository): UpdateProfileUseCase {
        return UpdateProfileUseCase(repository)
    }

    @Provides
    fun provideAddProfile(repository: IProfileRepository): AddProfileUseCase {
        return AddProfileUseCase(repository)
    }

    @Provides
    fun provideGetProfileList(repository: IProfileRepository): GetProfileListUseCase {
        return GetProfileListUseCase(repository)
    }

    @Provides
    fun provideGetProfileListFlow(repository: IProfileRepository): GetProfileListFlowUseCase {
        return GetProfileListFlowUseCase(repository)
    }

    @Provides
    fun provideRemoveProfile(repository: IProfileRepository): RemoveProfileUseCase {
    ...
    @Provides
    fun provideRemindManager(
        getNote: GetNoteByIdUseCase,
        updateNote: UpdateNoteNextTimestampUseCase,
        updateState: UpdateNoteStateUseCase
    ): IReminderManager {
